...
ActiveRecord::Schema.define(version: 2020_02_21_015819) do
  ...
  add_foreign_key "article_lines", "articles", column: "saleable_id", name: "article_lines_article_id_fk", on_delete: :restrict
