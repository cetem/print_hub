...
ActiveRecord::Schema.define(version: 20_150_411_204_711) do
  ...
  add_index 'document_tag_relations', %w(document_id tag_id), name: 'index_documents_tags_on_document_id_and_tag_id', unique: true, using: :btree
