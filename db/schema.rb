...
ActiveRecord::Schema.define(version: 20160322023517) do
  ...
  add_foreign_key "article_lines", "articles", name: "article_lines_article_id_fk"
  add_foreign_key "article_lines", "prints", name: "article_lines_print_id_fk"
  add_foreign_key "credits", "customers", name: "credits_customer_id_fk"
  add_foreign_key "order_lines", "documents", name: "order_lines_document_id_fk"
  ...
  add_foreign_key "print_jobs", "documents", name: "print_jobs_document_id_fk"
  add_foreign_key "print_jobs", "prints", name: "print_jobs_print_id_fk"
  add_foreign_key "prints", "customers", name: "prints_customer_id_fk"
  add_foreign_key "prints", "orders", name: "prints_order_id_fk"
  add_foreign_key "prints", "users", name: "prints_user_id_fk"
end
