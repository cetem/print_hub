...
ActiveRecord::Schema.define(:version => 20130504001357) do
  ...
  add_index "document_tag_relations", ["document_id", "tag_id"], :name => "index_documents_tags_on_document_id_and_tag_id", :unique => true
